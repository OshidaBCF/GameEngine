...
void Logger::PrintLog(const WCHAR* fmt, ...)
{
	...
	// Log File Location = %appdata%/GameEngine/Log/Log_2023_10_25_09_27_XX.log
...
void Logger::PrindDebugSeparator()
{
	WSTRING s = L"\n----------------------------------------------------------------------------\n\n";
#ifdef _DEBUG
	std::wfstream outfile;
...
// Private class to chack to see if MTail is already running
